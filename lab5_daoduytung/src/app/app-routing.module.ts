...
import { DuandetailComponent } from './duandetail/duandetail.component';
import { NvdetailComponent } from './nvdetail/nvdetail.component';
...
const routes: Routes = [
  ...
  {path: 'duan/detail/:id' , component: DuandetailComponent} ,
  {path: 'task/detail/:id' , component: TaskdetailComponent} ,
  {path: 'nhanvien/detail/:id' , component: NvdetailComponent} ,
];
